...
def visualize(fname):
    # use this for ckpt_fragloss_att
    #key_names = ['AbsRel', 'AbsDiff', 'SqRel', 'RMSE', 'LogRMSE', 'r1', 'r2', 'r3', 'complete', 'dist1', 'dist2', 'prec', 'recal', 'fscore']
    
    # use this for ckpt_fragloss_att_gru_semi
    key_names = ['AbsRel', 'AbsDiff', 'SqRel', 'RMSE', 'LogRMSE', 'r1', 'r2', 'r3', 'complete', 'comp', 'acc', 'prec', 'recal', 'fscore']
...
def main():
    ...
    rslt_file = os.path.join(args.model, 'scene0709_00_metrics.json')
    visualize(rslt_file)
