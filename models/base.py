...
class RadianceNet(nn.Module):
    ...
    def forward(
        ...
        #print("geometry_feature", geometry_feature.shape)
        radiance_input = torch.cat([x, view_dirs, geometry_feature], dim=-1)
        #radiance_input = torch.cat([x, view_dirs], dim=-1)
        
        h = radiance_input
        #print("radiance_input", radiance_input.shape)
        #print("self.D", self.D)
